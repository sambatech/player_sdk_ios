...
///
/// \param completionHandler A closure that your handler should call with either the value of the request<code>                         parameter, a modified URL request object, or NULL to refuse the redirect and 
/// 
...
///
/// \param completionHandler A completion handler that your code calls to continue the transfer, passing a<code>                         constant to indicate whether the transfer should continue as a data task or 
/// 
...
///
/// \param proposedResponse The default caching behavior. This behavior is determined based on the current<code>                         caching policy and the values of certain received headers, such as the Pragma 
/// 
///                          and Cache-Control headers.
/// 
/// </code>
///
/// \param completionHandler A block that your handler must call, providing either the original proposed<code>                         response, a modified version of that response, or NULL to prevent caching the 
/// 
...
///
/// \param location A file URL for the temporary file. Because the file is temporary, you must either<code>                    open the file for reading or move it to a permanent location in your app’s sandbox 
/// 
...
///
/// \param bytesWritten The number of bytes transferred since the last time this delegate<code>                                 method was called.
/// 
/// </code>
///
/// \param totalBytesWritten The total number of bytes transferred so far.
///
/// \param totalBytesExpectedToWrite The expected length of the file, as provided by the Content-Length<code>                                 header. If this header was not provided, the value is 
/// 
...
///
/// \param fileOffset If the file's cache policy or last modified date prevents reuse of the<code>                          existing content, then this value is zero. Otherwise, this value is an 
/// 
...
/// </code>
///
/// \param expectedTotalBytes The expected length of the file, as provided by the Content-Length header.<code>                          If this header was not provided, the value is NSURLSessionTransferSizeUnknown.
/// 
/// </code>
